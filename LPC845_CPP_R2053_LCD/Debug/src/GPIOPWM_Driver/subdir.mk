...
CPP_DEPS += \
./src/GPIOPWM_Driver/GpioPWM.d 

OBJS += \
./src/GPIOPWM_Driver/GpioPWM.o 


# Each subdirectory must supply rules for building sources it contributes
src/GPIOPWM_Driver/%.o: ../src/GPIOPWM_Driver/%.cpp src/GPIOPWM_Driver/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-GPIOPWM_Driver

clean-src-2f-GPIOPWM_Driver:
	-$(RM) ./src/GPIOPWM_Driver/GpioPWM.d ./src/GPIOPWM_Driver/GpioPWM.o

.PHONY: clean-src-2f-GPIOPWM_Driver

...
CPP_DEPS += \
./src/SENSOR_Driver/sensoragua.d 

OBJS += \
./src/SENSOR_Driver/sensoragua.o 


# Each subdirectory must supply rules for building sources it contributes
src/SENSOR_Driver/%.o: ../src/SENSOR_Driver/%.cpp src/SENSOR_Driver/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-SENSOR_Driver

clean-src-2f-SENSOR_Driver:
	-$(RM) ./src/SENSOR_Driver/sensoragua.d ./src/SENSOR_Driver/sensoragua.o

.PHONY: clean-src-2f-SENSOR_Driver
